...
const InstitutionType_1 = require("./InstitutionType");
const SchoolSchema = new mongoose_1.Schema({
    ...
    sector: {
        type: String,
        enum: Object.values(InstitutionType_1.EducationSector),
        required: true
    },
...
SchoolSchema.index({ institutionTypeId: 1 });
SchoolSchema.index({ sector: 1 });
